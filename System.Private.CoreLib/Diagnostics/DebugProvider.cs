...
public class DebugProvider
{
    ...
    public static extern void FailCore(string stackTrace, string? message, string? detailMessage, string errorSource);

    [MethodImpl(MethodCodeType = MethodCodeType.Native)]
    public static extern void WriteCore(string message);
