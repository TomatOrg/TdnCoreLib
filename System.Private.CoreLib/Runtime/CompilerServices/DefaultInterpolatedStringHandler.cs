...
public ref struct DefaultInterpolatedStringHandler
{
    ...
    {
        _provider = null;
        _chars = _arrayToReturnToPool = new char[GetDefaultLength(literalLength, formattedCount)]; // TODO: ArrayPool<char>.Shared.Rent(GetDefaultLength(literalLength, formattedCount));
        _pos = 0;
    ...
    internal void Clear()
    {
        ...
        {
            // TODO: ArrayPool<char>.Shared.Return(toReturn);
        }
    }
    ...
    internal static bool HasCustomFormatter(IFormatProvider provider)
    {
        ...
        // TODO: Debug.Assert(provider is not CultureInfo || provider.GetFormat(typeof(ICustomFormatter)) is null, "Expected CultureInfo to not provide a custom formatter");
        return
            // TODO: provider.GetType() != typeof(CultureInfo) && // optimization to avoid GetFormat in the majority case
    ...
    private void GrowCore(uint requiredMinCapacity)
    {
        ...
        char[] newArray = new char[arraySize];// TODO: ArrayPool<char>.Shared.Rent(arraySize);
