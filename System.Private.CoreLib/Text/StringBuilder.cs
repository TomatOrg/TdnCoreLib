...
public sealed partial class StringBuilder
{
    ...
    public StringBuilder(string? value, int startIndex, int length, int capacity)
    {
        ...
        // TODO: m_ChunkChars = GC.AllocateUninitializedArray<char>(capacity);
    ...
    public int Capacity
    {
        ...
        set
        {
            ...
            if (Capacity != value)
            {
                ...
                // TODO: char[] newArray = GC.AllocateUninitializedArray<char>(newLen);
...
#pragma warning restore CA1830
    ...
    private StringBuilder(int size, int maxCapacity, StringBuilder? previousBlock)
    {
        ...
        // TODO: m_ChunkChars = GC.AllocateUninitializedArray<char>(size);
